...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="La date d'arriveé doit être ultérieur à la date d'aujourd'hui")
     */
    private $startDate;
    ...
    /**
     * Callback appeleé à chaque fois qu'on créé une réesrvation
     *
     * @ORM\PrePersist()
     * @throws \Exception
     */
